...
class ObjectExercisesTest {
    ...
    void transformValues_shouldUppercaseOnlyStringFields() {
        User user = new User(1, "Alice", 25, true);
        Map<String, Object> result = ObjectExercises.transformValues(user, String.class, String::toUpperCase);
    ...
    // 5. flatToNested — reste sur Map car la structure "clés avec points" n'existe que dans ce contexte
    @Test
    ...
    void findMaxValue_shouldThrowIfNoNumericField() {
        ...
        assertThrows(NoSuchElementException.class,
                () -> ObjectExercises.findMaxValue(new Object()));
    }
    ...
    void createObjectFromPairs_shouldBuildMapFromPairs() {
        List<Object[]> pairs = Arrays.asList(
                new Object[]{"pommes", 2.5},
                new Object[]{"bananes", 1.8}
        );
