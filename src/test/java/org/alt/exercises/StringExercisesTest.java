...
class StringExercisesTest {
    ...
    void removeDuplicates_shouldRemoveConsecutiveDuplicates() {
        assertEquals("Bonjour ! J'ai besoin d'aide.", StringExercises.removeDuplicates("Bonjouuuur !!! J'ai besoiiiin d'aide...."));
    }
    ...
    void truncate_shouldTruncateWithEllipsis() {
        assertEquals("Ceci est une très...", StringExercises.truncate("Ceci est une très longue description d'un produit", 20));
    }
    ...
    void capitalizeWords_shouldCapitalizeEachWord() {
        assertEquals("Bienvenue Sur Notre Site Web", StringExercises.capitalizeWords("bienvenue sur notre site web"));
    }
